...
public class Page<T> {
	...
	private int pageNo = 1; // 当前页码totalNo
	...
	public String toString() {
		...
		for (int i = begin; i <= end; i++) {
			if (i == pageNo) {
				sb.append("<a class='active' style='background: #d3a968;color: #fff;' href=\"javascript:\">" + (i + 1 - first)
						+ "</a>\n");
			} else {
				sb.append("<a href=\"javascript:\" onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">"
						+ (i + 1 - first) + "</a>\n");
...
//		//class:商城页面-我的订单模块调用该class
//		sb.insert(0,"<ul class=\"orderblock\">\n").append("</ul>\n");
